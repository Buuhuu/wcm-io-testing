...
import io.wcm.config.application.impl.ApplicationFinderImpl;
import io.wcm.config.application.impl.ApplicationImplementationPicker;
import io.wcm.config.application.spi.ApplicationProvider;
import io.wcm.config.application.spi.helpers.AbstractPathApplicationProvider;
